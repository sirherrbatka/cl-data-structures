...
(defmacro bind-lambda (fn &rest args)
  "Curry function. For instance (bind-lambda #'+ 2 :_) is like (curry #+ 2). However this can be used to bind more arguments. For instance (bind-lambda #'/ 5 :_ 3 :_ 4 :_ 2 :_ :_ 12)"
  (once-only (fn)
    (let* ((args-count 0)
           (fargs nil)
           (binded nil)
